...
#define _DUTY_MAX 2169 // 2000
#define _DUTY_NEU 1500 // 1500
#define _DUTY_MIN 849 // 1000

#define _SERVO_ANGLE_DIFF  245  // Replace with |D - E| degree
...
float volt_to_distance(int a_value)
{
  ...
  return 475 + (-3.28)*a_value + 0.0134*a_value*a_value + (-1.93E-05)*a_value*a_value*a_value;
  //return 493 + (-2.43)*a_value + (4.5E-03)*a_value*a_value + (-3.04E-06)*a_value*a_value*a_value;
}
